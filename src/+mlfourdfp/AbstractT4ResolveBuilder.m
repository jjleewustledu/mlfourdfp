classdef (Abstract) AbstractT4ResolveBuilder < mlfourdfp.AbstractSessionBuilder & mlfourdfp.IT4ResolveBuilder
    ...
    methods 
        ...
        function fp    = buildMaskForImages(this, varargin)
            ...
            ic1 = ImagingContext2([fqfp1 '.4dfp.hdr']);
            ic2 = ImagingContext2([fqfp2 '.4dfp.hdr']);
            ic  = ImagingContext2(ic1 + ic2);
            ic  = ic.thresh(ic.dipmax*this.maskForImagesThreshFactor);
            ic  = ic.binarized;
            ic.saveas([ip.Results.fp '.4dfp.hdr']);
            fp  = ic.fqfileprefix;
