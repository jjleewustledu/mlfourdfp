classdef Test_Viewer < matlab.unittest.TestCase
	%% TEST_VIEWER 

	%  Usage:  >> results = run(mlfourdfp_unittest.Test_Viewer)
 	%          >> result  = run(mlfourdfp_unittest.Test_Viewer, 'test_dt')
	...
	methods (Test)
 	...
 	methods (TestClassSetup)
		function setupViewer(this)
 			import mlfourdfp.*;
 			this.testObj_ = Viewer;
 		end
	end

 	methods (TestMethodSetup)
		function setupViewerTest(this)
